...
public class AlertsTests extends TestBase {
    ...
    public void waitAlertTest(){
        new AlertsFrameWidowsPage(driver).waitAlert();
    }

    @Test
    public void selectConfirmTest(){
        new AlertsFrameWidowsPage(driver).selectResult("Cancel")
                . verifyResult("Cancel");
    }
    @Test
    public void sendMessageToAlertTest(){
        new AlertsFrameWidowsPage(driver).sendMessageToAlert("Hi dear!!")
        .verifyMessage("Hi dear!!");
    }
}
