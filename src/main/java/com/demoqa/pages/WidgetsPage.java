...
public class WidgetsPage extends BasePage{
    ...
    @FindBy(id = "cars")
    WebElement cars;
    public WidgetsPage standartMultiSelect(String[] car) {
        ...
        List<WebElement> selectOpt = select.getAllSelectedOptions();
    ...
    public WidgetsPage moveSlider() {
        ...
        actions.dragAndDropBy(sliderContainer,260,0).perform();   //actions.moveToElement(sliderContainer,200,0);
        pause(1000);
