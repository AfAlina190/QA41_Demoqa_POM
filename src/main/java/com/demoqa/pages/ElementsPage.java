...
public class ElementsPage extends BasePage{
    ...
    public ElementsPage performMouseEvent() {
        ...
        int x = dimension.getWidth() / 4+ 700;
    ...
    public ElementsPage checkBrokenImages() {
        ...
        System.out.println("Total img on the web page: " + images.size());

        //check the received img
    ...
    public ElementsPage keyBoardEvent(String address) {
        ...
        //pass current address in permanent address field
